...
namespace moleQule.Serie
{
    ...
    public class SerieFamilias : BusinessListBaseEx<SerieFamilias, SerieFamilia>
    {
        ...
        public static string SELECT(QueryConditions conditions) { return SerieFamilia.SELECT(conditions, true); }
        public static string SELECT(Serie item) { return SELECT(new QueryConditions { Serie = item.GetInfo() }); }
        public static string SELECT(Familia item) { return SELECT(new QueryConditions { Family = item.GetInfo() }); }
