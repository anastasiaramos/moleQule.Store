...
namespace moleQule.Library.Store
{
	...
	{		 
        ...
        {
			QueryConditions conditions = new Library.Store.QueryConditions { TipoSerie = tipo };
        ...
        public static string SELECT(Library.Store.QueryConditions conditions) { return Serie.SELECT(conditions, false); }
