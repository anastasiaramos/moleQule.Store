...
namespace moleQule.Library.Store
{
	...
	/// </summary>
	[Serializable()]
	public class SerieInfo : ReadOnlyBaseEx<SerieInfo, Serie>
	{	
		#region Attributes
		...
		{
			if (!Serie.CanGetObject()) throw new System.Security.SecurityException(Library.Resources.Messages.USER_NOT_ALLOWED);
