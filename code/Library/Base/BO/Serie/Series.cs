...
namespace moleQule.Library.Store
{
    ...
    public class Series : BusinessListBaseEx<Series, Serie>
    {
        ...
        public static string SELECT(Library.Store.QueryConditions conditions) { return Serie.SELECT(conditions, true); }
        public static string SELECT(ETipoSerie tipo)
        {
            string query;

            query = SELECT(new Library.Store.QueryConditions { TipoSerie = tipo }) +
                    " ORDER BY S.\"NOMBRE\"";
