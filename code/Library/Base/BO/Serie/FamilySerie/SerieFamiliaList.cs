...
namespace moleQule.Library.Store
{
    ...
    public class SerieFamiliaList : ReadOnlyListBaseEx<SerieFamiliaList, SerieFamiliaInfo>
    {
        ...
        public static string SELECT(Library.Store.QueryConditions conditions) { return SerieFamilia.SELECT(conditions, false); }
        public static string SELECT(SerieInfo item) { return SELECT(new Library.Store.QueryConditions { Serie = item }); }
        public static string SELECT(FamiliaInfo item) { return SELECT(new Library.Store.QueryConditions { Familia = item }); }
