...
namespace moleQule.Library.Store
{
    ...
    public class InterestRate : BusinessBaseEx<InterestRate>
    {
        ...
        private bool CheckValidation(object target, Csla.Validation.RuleArgs e)
        {
            ...
            if (OidPrestamo <= 0)
            {
                e.Description = String.Format(moleQule.Resources.Messages.NO_VALUE_SELECTED, "OidPrestamo");
        ...
        {
            QueryConditions conditions = new QueryConditions { Loan = item.GetInfo(false) };
