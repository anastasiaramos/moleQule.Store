...
namespace moleQule.Library.Store
{
    ...
    public class Loan : BusinessBaseEx<Loan>, IBankLine, ITransactionPayment, IEntidadRegistro
	{
        ...
        private bool CheckValidation(object target, Csla.Validation.RuleArgs e)
        {
            ...
            if (OidCuenta <= 0)
            {
                e.Description = String.Format(moleQule.Resources.Messages.NO_FIELD_SELECTED, "OidCuenta");
            ...
            {
                e.Description = String.Format(moleQule.Resources.Messages.NO_FIELD_FILLED, "Nombre");
                throw new iQValidationException(e.Description, string.Empty);
            }
            ...
            {
                e.Description = moleQule.Resources.Messages.NO_ID_SELECTED;
                throw new iQValidationException(e.Description, string.Empty);
            }
        ...
        {
            return AutorizationRulesControler.CanGetObject(moleQule.Resources.SecureItems.ESTADO);
        }
        ...
        internal void DeleteSelf(Loans parent)
        {
            ...
            BankLine.BankLine.AnnulItem(this, parent.SessionCode);
        ...
        private void DataPortal_Delete(CriteriaCs criteria)
        {
            try
            {
                ...
                BankLine.BankLine.AnnulItem(obj, SessionCode);
