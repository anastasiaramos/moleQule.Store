namespace moleQule.Face.Store
{
    partial class SerieAddForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// Precios_Panel
			// 
			this.Precios_Panel.Size = new System.Drawing.Size(607, 359);
			// 
			// PanelesV
			// 
			// 
			...
			this.Name = "SerieAddForm";
			this.HelpProvider.SetShowHelp(this, true);
			this.Text = "Nueva Serie";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.SerieAddForm_FormClosing);
