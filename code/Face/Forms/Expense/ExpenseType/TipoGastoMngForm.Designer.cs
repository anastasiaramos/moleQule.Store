...
{
    partial class TipoGastoMngForm 
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TipoGastoMngForm));
			...
			// Campos_Panel
			// 
			this.Campos_Panel.Location = new System.Drawing.Point(53, 0);
			...
			// DatosLocal_BS
			// 
            this.DatosLocal_BS.DataSource = typeof(moleQule.Library.Store.TipoGastoList);
			// 
			// Tabla
			// 
			...
			// Categoria
			// 
			this.Categoria.DataPropertyName = "CategoriaGastoLabel";
			...
			this.DiasPago.DefaultCellStyle = dataGridViewCellStyle3;
			...
			this.Observaciones.MinimumWidth = 190;
