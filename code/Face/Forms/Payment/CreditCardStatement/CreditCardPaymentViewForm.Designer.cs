...
{
    partial class CreditCardPaymentViewForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.Statements_SC.SuspendLayout();
            ...
            this.Name = "CreditCardPaymentViewForm";
			this.HelpProvider.SetShowHelp(this, true);
			this.Text = "Detalle de Pago";
			this.Shown += new System.EventHandler(this.CreditCardPaymentViewForm_Shown);
			((System.ComponentModel.ISupportInitialize)(this.Lines_BS)).EndInit();
			this.Statements_SC.ResumeLayout(false);
