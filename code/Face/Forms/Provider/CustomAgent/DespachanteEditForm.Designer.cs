...
{
    partial class DespachanteEditForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			// Productos_Panel
			// 
			this.Productos_Panel.Size = new System.Drawing.Size(928, 586);
			// 
			// CuentaContable_TB
			// 
			this.CuentaContable_TB.ForeColor = System.Drawing.Color.Black;
			// 
			// SendMail_BT
			// 
			...
			this.PanelesV.SplitterDistance = 193;
			// 
			// Submit_BT
			// 
			...
			this.Paneles2.Size = new System.Drawing.Size(513, 37);
			// 
			// Imprimir_Button
			// 
			this.Imprimir_Button.Location = new System.Drawing.Point(352, 7);
			...
			this.Name = "DespachanteEditForm";
			this.HelpProvider.SetShowHelp(this, true);
			this.Text = "Modificar Despachante";
